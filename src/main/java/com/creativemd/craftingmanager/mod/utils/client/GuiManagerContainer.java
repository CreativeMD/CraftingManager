...
public abstract class GuiManagerContainer extends GuiContainer
{
    ...
    public GuiManagerContainer(Container p_i1072_1_)
    {
    	super(p_i1072_1_);
    ...
    public void func_146977_a(Slot p_146977_1_)
    {
        ...
        if (!flag1)
        {
            ...
            try
            {
            	...
            	itemRender.renderIcon(i, j, icon, 16, 16);
