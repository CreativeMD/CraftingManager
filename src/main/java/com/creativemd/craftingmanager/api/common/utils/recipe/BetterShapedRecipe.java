package com.creativemd.craftingmanager.api.common.utils.recipe;
...
public class BetterShapedRecipe extends ShapedOreRecipe{
	...
	public BetterShapedRecipe(ItemStack par4ItemStack, Object[] itemInfo, Object ... par3ArrayOfItemStack) {
        ...
        itemData = new ItemInfo[width * height];
        int x = 0;
        for (char chr : shape.toCharArray())
        {
        	itemData[x++] = (ItemInfo) itemMap.get(chr);
        }
        this.recipeHeight = height;
        this.recipeWidth = width;
    }
	
	public boolean checkItemEquals(ItemStack target, ItemStack input, ItemInfo info)
    {
